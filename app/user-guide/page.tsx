...
export default function UserGuidePage() {
  return (
    <main className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-blue-500/30">
      ...
      {/* 1. HERO SECTION */}
      <section className="bg-slate-950 pt-32 pb-20 px-6 text-center relative overflow-hidden">
        {/* Background Glow */}
      ...
      <section className="px-6 -mt-10 relative z-20">
        <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl shadow-blue-900/10 border border-slate-200 p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <button className="px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-bold text-lg transition-all shadow-lg hover:shadow-blue-500/25 flex items-center gap-3 w-full md:w-auto justify-center animate-pulse">
      ...
      <section className="py-20 px-6 max-w-4xl mx-auto">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-slate-900 mb-6 flex items-center gap-3">
            <span className="w-8 h-8 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center text-sm font-bold">01</span>
          ...
          <div className="prose prose-lg text-slate-600 max-w-none space-y-8">
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
              <h3 className="text-xl font-bold text-slate-900 mb-3 flex items-center gap-2">
                <Shield className="w-5 h-5 text-indigo-500" /> The Sentinel (HR)
              </h3>
              <p>
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
              <h3 className="text-xl font-bold text-slate-900 mb-3 flex items-center gap-2">
                <Zap className="w-5 h-5 text-yellow-500" /> The Closer (Sales)
              </h3>
              <p>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-slate-900 mb-6 flex items-center gap-3">
            <span className="w-8 h-8 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center text-sm font-bold">02</span>
          ...
          <div className="bg-slate-900 text-slate-300 p-8 rounded-2xl border border-slate-700 shadow-xl">
             <h3 className="text-xl font-bold text-white mb-4">Why build your own?</h3>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-slate-900 mb-6 flex items-center gap-3">
            <span className="w-8 h-8 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center text-sm font-bold">03</span>
            Custom Agents (The Forge)
          </h2>
          
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
             <h3 className="text-xl font-bold text-slate-900 mb-4 flex items-center gap-2">
               <Cpu className="w-5 h-5 text-purple-500" /> How to use the Builder
             </h3>
      ...
      {/* 4. FOOTER NAVIGATION */}
      <section className="bg-slate-100 py-12 px-6 border-t border-slate-200">
